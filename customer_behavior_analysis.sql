...
-- Q3. Whcih are the top 5 products with the highest average review rating?
...
select count(previous_purchases) as total_count,
(case 
when previous_purchases <= 10 and previous_purchases > 1 then "Returning" 
when previous_purchases > 10 then "Loyal" else "New"
